...
async function getBlogData(slug) {
  ...
  try {
    ...
    const res = await fetch(
      `https://faridabad-backend.onrender.com/blogs/getBlogBySlug/${slug}?domain=www.commercialprojectsinfaridabad.com`,
      {
         cache: "force-cache",
...
return {
  ...
  alternates: {
    canonical: `https://www.commercialprojectsinfaridabad.com/blog/${slug}`,
  },
};
}
