  ...
  return (
    <section className="w-full bg-[#0f172a] py-6 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="rounded-[36px] border border-white/10 bg-[#1f2937] p-8 md:p-14 shadow-xl">
...
>
            ...
            <p className="text-base md:text-lg leading-8 md:leading-9 text-gray-300">
              ...
              <span className="font-semibold text-[#FFA6A6]">
                CommercialProjectsInFaridabad.com
              </span>
              {" "}
              — Faridabad has emerged as one of the fastest-growing commercial destinations in the National Capital Region (NCR). With excellent road connectivity through NH-19, Delhi-Mumbai Expressway, and the metro network, the city offers unmatched opportunities for businesses, investors, and entrepreneurs.
            </p>
